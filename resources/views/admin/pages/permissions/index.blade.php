...
@section('content_header')
    ...
    <div class="d-flex">
        <h1>Permissões</h1>
        <a href="{{ route('permissions.create') }}" class="btn btn-dark ml-2">Adicionar</a>
    </div>
@stop
                    ...
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            <td style="width=10px">
                                ...
                                <a href="{{ route('permissions.profiles', $permission->id) }}" class="btn btn-info"><i class="far fa-address-book"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
